...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: [
      ...
      `${provider.specialty || "beauty specialist provider"} specialist`,
      `${provider.name} reviews`,
      `${provider.businessName} services`,
      `best ${provider.specialty || "beauty specialist provider"} near me`,
      `${provider.name} portfolio`,
      `award-winning ${provider?.specialty || "beauty specialist provider"}`,
      `${provider.businessName} pricing`,
    ],
    openGraph: {
      title: `${provider.businessName || provider.firstName} | Hairsby Professional`,
      description: `${provider.businessName || provider.firstName} - ${provider.specialty || "beauty specialist provider"} at ${provider.businessName || "their studio"} in ${provider.location}`,
