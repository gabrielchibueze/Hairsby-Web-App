// // app/(provider)/settings/components/schedule-editor.tsx
// "use client";
...
//         [day]: {
//           ...workingHours[day],
//           breaks: [...workingHours[day].breaks, { start: "12:00", end: "13:00" }],
//         },
//       },
//     };
//     onChange(updatedSchedule);
...
//             {workingHours[day].breaks.map((breakItem: any, index: number) => (
//               <div key={index} className="flex items-center space-x-4 pl-8">
