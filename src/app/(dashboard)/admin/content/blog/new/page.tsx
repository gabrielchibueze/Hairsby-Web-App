...
// import { createBlog } from "@/lib/api/contents/blog";
...
export default function NewBlogPostPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      // Prepare the blog data payload with proper typing
      const blogData: BlogData = {
        ...
        tags: values.tags
          ...
          : [],
        type: "blog", // explicitly set to "blog" to match the BlogData type
      };

      await createBlog(blogData, images);
