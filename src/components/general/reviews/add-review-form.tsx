...
import { addProductReview } from "@/lib/api/products/product";
import { convertFileToBase64 } from "@/lib/utils";
import { Input } from "@/components/ui/input";
import { addServiceReview } from "@/lib/api/services/service";
...
export function AddReviewForm({ id, type }: AddReviewFormProps) {
